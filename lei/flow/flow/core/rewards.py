...
##################################
    ...
    for rl_id in range(len(rl_actions)):
        ...
        # gen_traffics返回的edge id有错 这里作出修正
        # 2*2路网
        if rl_id == 0:
            traffics = ['bot0_0', 'right0_0', 'left1_0', 'top0_1']
        elif rl_id == 1:
            traffics = ['bot0_1', 'right0_1', 'left1_1', 'top0_2']
        elif rl_id == 2:
            traffics = ['bot1_0', 'right1_0', 'left2_0', 'top1_1']
        elif rl_id == 3:
            traffics = ['bot1_1', 'right1_1', 'left2_1', 'top1_2']
        ...
        # print("traffics[1]:", traffics[1])
        # print("vehs_on_edge_horizon1:", vehs_on_edge_horizon1)
        # print("traffics[2]:", traffics[2])
        # print("vehs_on_edge_horizon2:", vehs_on_edge_horizon2)
        ...
        for i in range(len(pos_horizon1)):
            if pos_horizon1[i] > 0 and speed_horizon1[i] < speed_punish:
                num_horizon1 += 1
        for i in range(len(pos_horizon2)):
            if pos_horizon2[i] > 0 and speed_horizon2[i] < speed_punish:
                num_horizon2 += 1
        ...
        # print("traffics[0]:", traffics[0])
        # print("vehs_on_edge_vertical1:", vehs_on_edge_vertical1)
        # print("traffics[3]:", traffics[3])
        # print("vehs_on_edge_vertical2:", vehs_on_edge_vertical2)
        ...
        for i in range(len(pos_vertical1)):
            if pos_vertical1[i] > 0 and speed_vertical1[i] < speed_punish:
                num_vertical1 += 1
        for i in range(len(pos_vertical2)):
            if pos_vertical2[i] > 0 and speed_vertical2[i] < speed_punish:
                num_vertical2 += 1
        ...
        rew[rl_id] = -1/2 * rew[rl_id]  # 惩罚的负数即为奖励
