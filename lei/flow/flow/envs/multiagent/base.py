...
class MultiEnv(MultiAgentEnv, Env):
    ...
    def step(self, rl_actions):
        ...
        #print("===take a step at this environment!!===")
        ...
        # 先模拟几次
        for _ in range(self.env_params.sims_per_step):  # from 'EnvParams' object
            ...
            #print("rl_actions(before applyed): ", rl_actions)
        ...
        if self.env_params.clip_actions:
            ...
            reward = self.compute_reward(clipped_actions, fail=crash)   # from mytraffic_light_grid.py  
        else:
            reward = self.compute_reward(rl_actions, fail=crash)

        #print("env reward(inner): ", reward)
    ...
    # 这个方法每步执行了4次(前三次是simulate)(这个是重载方法)
    ...
    def apply_rl_actions(self, rl_actions=None):
        ...
        # clip according to the action space requirements
        clipped_actions = self.clip_actions(rl_actions) # from MyMultiTrafficLightGridPOEnv object
        self._apply_rl_actions(clipped_actions) # from mytraffic_light_grid.py
